# start_ngrok.py
# Exposes this app (port 8090) publicly for a demo. NOT for production use:
# no auth in front of the tunnel beyond whatever this app itself enforces.
#
# Never hardcode NGROK_AUTHTOKEN in this file -- a hardcoded token has
# leaked into git history before and had to be rotated.
import os
import sys
import time
